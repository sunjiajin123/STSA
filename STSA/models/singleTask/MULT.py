...
class MULT(nn.Module):
    def __init__(self, args):
        ...
        dst_feature_dims, nheads = args.dst_feature_dim_nheads                                #   30,10
        self.orig_d_l, self.orig_d_a, self.orig_d_v = args.feature_dims                        #768 ,5 ,20
        self.d_l = self.d_a = self.d_v = dst_feature_dims                                       #30
        self.num_heads = nheads
        self.layers = args.nlevels                                                             # 4
    ...
    def forward(self, text, audio, video):
        ...
        proj_x_v = x_v if self.orig_d_v == self.d_v else self.proj_v(x_v)                   #(8,30,498)
