...
class SELF_MM(nn.Module):
    def __init__(self, args):
        ...
        # text subnets
        self.aligned = args.need_data_aligned                                                                              #不对齐
        self.text_model = BertTextEncoder(language=args.language, use_finetune=args.use_finetune)                          #bert作为text的网络，而lstm作为text与video的网络
        ...
        self.post_fusion_layer_1 = nn.Linear(args.text_out + args.video_out + args.audio_out, args.post_fusion_dim)             #768+16+32
        self.post_fusion_layer_2 = nn.Linear(args.post_fusion_dim, args.post_fusion_dim)                                        #128
    ...
    def forward(self, text, audio, video):
        ...
        text = self.text_model(text)[:,0,:]                                                               #class label
