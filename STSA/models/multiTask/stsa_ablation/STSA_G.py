...
class STSA_G(nn.Module):

    def __init__(self, args):
        super(STSA_G, self).__init__()
        ...
        self.linear_text_3=nn.Linear(20,self.output_dim)
        ...
        self.linear_audio_3 = nn.Linear(20, self.output_dim)
        ...
        self.linear_vision_3 = nn.Linear(20, self.output_dim)
        ...
        self.linear_fuse_audio_3 = nn.Linear(20, self.output_dim)
        ...
        self.linear_f_3 = nn.Linear(20, self.output_dim)
    ...
    def forward(self, text_x, audio_x, video_x):
        ...
        fuse_1=self.fusenet1(text_h,audio_h,torch.squeeze(text_output_1),torch.squeeze(audio_output_1))
        ...
        fuse_2=self.fusenet2(fuse_1,vision_h,audio_fuse_output_1,vision_output_1)



        fuse_output=self.linear_f_3(self.linear_f_2(self.linear_f_1(fuse_2[:,0,:])))
