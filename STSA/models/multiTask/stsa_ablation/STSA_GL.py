...
class STSA_GL(nn.Module):

    def __init__(self, args):
        super(STSA_GL, self).__init__()
        ...
        self.linear_f_1=nn.Linear(140,100)
    ...
    def forward(self, text_x, audio_x, video_x):
        ...
        fuse_output = self.linear_f_3(self.linear_f_2(self.linear_f_1(final_all)))
